...
DATE_TIME timestamp NOT NULL,
TEXT VARCHAR(250),
FROM_USER_ID int8 REFERENCES T_USER(ID),
PHOTO_ID int8 REFERENCES T_PHOTO(ID));

CREATE TABLE T_MESSAGE_TO_USER (
TO_USER_ID int8 REFERENCES T_USER(ID),
MESSAGE_DETAILS_ID int8 REFERENCES T_MESSAGE_DETAILS(ID),
