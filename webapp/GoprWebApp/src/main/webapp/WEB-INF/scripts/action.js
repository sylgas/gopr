...
require([
    ...
    function initAction() {
        ...
        $.getJSON("http://localhost:8090/rest/layer/get", {actionId: 1})
            .done(function (data) {
                displayAreas(data);
            })
            .fail(function () {
        ...
        $.getJSON("http://localhost:8090/rest/point/getAllPoints", {actionId: 1})
            .done(function (data){
        ...
        window.setInterval(function () {
            $.getJSON("http://localhost:8090/rest/point/get", {actionId: 1, dateTime: new Date().getTime()})
                .done(function (data){
                    index = displayPoints(data, index);
                })
                .fail(function () {
